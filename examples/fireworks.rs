...
/// PRO: genera un cohete cuyo ápice cae dentro de una banda visible del terminal.
/// Mantiene el modelo del demo: velocidad en px/frame aprox; posición integra con *dt*60.
fn spawn_rocket_pro(rng: &mut ThreadRng, w_px: usize, h_px: usize) -> Rocket {
    ...
    // Física en "por frame" (asumiendo ~60fps como referencia para calcular vy/fuse):
